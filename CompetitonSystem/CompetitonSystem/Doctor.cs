...
namespace CompetitonSystem
{
    public partial class Doctor : Form
    {
        ...
        {
            // TODO: 这行代码将数据加载到表“赛事管理系统DataSet.队医”中。您可以根据需要移动或删除它。
            this.队医TableAdapter.Fill(this.赛事管理系统DataSet.队医);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //使用获得的p_no删除数据库的数据
            string SQL = "delete from 队医 where 编号=" + p_no;
            odbcCon.Open(); 
        ...
        {
            this.队医TableAdapter.Update(this.赛事管理系统DataSet.队医);
        }
